        ...
        <div class="panel">
            ...
            <form wire:submit="processInvoice" class="mt-5 space-y-4">
                <div class="rounded-3xl border border-slate-200 bg-slate-50/90 p-4">
                    ...
                    <div class="mt-4 grid gap-4 lg:grid-cols-[0.75fr_0.55fr_0.8fr_0.8fr_0.8fr]">
                        <div>
                ...
                <button type="submit" class="btn btn-primary w-full">Proses Invoice & Download PDF</button>
            </form>
        </div>
